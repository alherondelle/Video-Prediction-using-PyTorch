...
def compute_act_inceptionv3(img_true, img_false):
    resized_A1 = nn.functional.interpolate(img_false, size=(299,299), mode='bilinear', align_corners=False)
    resized_real_A = nn.functional.interpolate(img_true, size=(299,299), mode='bilinear', align_corners=False)
